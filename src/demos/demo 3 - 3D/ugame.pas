...
begin
  ...
  stream := FileSystem.ReadResource('data/Lara_Croft_default.obj');
  meshData2 := resload.LoadMesh(stream, mfObj);
  stream.Free();
end;
...
begin
  ...
  Camera.SetCamera(Vec3f(30, 30, 30), Vec3f(0, 0, 0), Vec3f(0, 1, 0));
  Camera.Viewport(0, 0, Render.Width, Render.Height, 45, 0.1, 200);
end;
